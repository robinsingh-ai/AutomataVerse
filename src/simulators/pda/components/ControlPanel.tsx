    ...
    <DraggablePanel title="PDA Control" defaultPosition={{ x: 20, y: 130 }}>
      <div className="space-y-4">
        ...
        <div className={`pt-4 border-t ${isDark ? 'border-gray-700' : 'border-gray-200'}`}>
          ...
          {/* Display stack content if available */}
          {stack && stack.content.length > 0 && (
            <div className="mt-3 p-3 rounded border font-mono text-sm overflow-x-auto whitespace-nowrap flex items-start gap-2">
