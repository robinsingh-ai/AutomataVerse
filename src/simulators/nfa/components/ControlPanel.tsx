...
const ControlPanel: React.FC<ControlPanelProps> = ({
  ...
  return (
    <DraggablePanel title="NFA Control" defaultPosition={{ x: 20, y: 130 }}>
      <div className="space-y-3">
        ...
        <div className="space-y-1.5">
          ...
          >
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 15l-5-5-5 5M7 9l5-5 5 5" />
            </svg>
            <span>{allowEpsilon ? 'Disable ε-transitions' : 'Enable ε-transitions'}</span>
          </button>
        </div>
          ...
          {validationResult && (
            <div className={`mt-3 p-3 rounded ${
              ...
              <span className="mt-0.5">
                {validationResult.includes("Accept") || validationResult.includes("Valid") ? (
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                ) : (
