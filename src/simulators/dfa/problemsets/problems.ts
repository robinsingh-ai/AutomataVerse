...
export const DFA_PROBLEMS: Record<string, DFAProblem> = {
  "dfa-endswith-ab": {
    ...
    description:
      'Construct a DFA that recognizes the following language of strings over the alphabet {a,b}: All words that end with an "ab".',
  ...
  "dfa-startswith-aa": {
    ...
    description:
      'Construct a DFA that accepts all strings over the alphabet {a,b} that start with "aa".',
  ...
  "dfa-contains-aab": {
    ...
    description:
      'Construct a DFA that accepts all strings over the alphabet {a,b} that contain the substring "aab".',
  ...
  "dfa-even-as-odd-bs": {
    ...
    description:
      "Construct a DFA that accepts strings over the alphabet {a,b} that have an even number of a's and an odd number of b's.",
  ...
  "dfa-divisible-by-3": {
    ...
    description:
      "Construct a DFA that accepts binary strings (0s and 1s) that represent numbers divisible by 3. The string is read from left to right, with the leftmost bit being the most significant.",
  ...
  "dfa-ends-with-aba": {
    ...
    description:
      'Construct a DFA that recognizes the language of all strings over the alphabet {a,b} that end with "aba".',
  ...
  "dfa-no-consecutive-as": {
    ...
    description:
      "Construct a DFA that accepts all strings over the alphabet {a,b} that do not contain two consecutive a's.",
  ...
  "dfa-alternating-ab": {
    ...
    description:
      "Construct a DFA that accepts all strings over the alphabet {a,b} where a's and b's alternate (the empty string is accepted).",
  ...
  "dfa-no-substring-abba": {
    ...
    description:
      'Construct a DFA that accepts all strings over the alphabet {a,b} that do not contain the substring "abba".',
    accept: ["", "a", "b", "ab", "ba", "abb", "bba", "abab", "babb", "aabbb"],
    reject: ["abba", "abbab", "babba", "aabbaa", "ababba"],
    difficulty: "Hard",
  },
  "dfa-alternating-parity": {
    id: "dfa-alternating-parity",
