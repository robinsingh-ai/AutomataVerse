...
const ControlPanel: React.FC<ControlPanelProps> = ({
  ...
  return (
    <DraggablePanel title="DFA Control" defaultPosition={{ x: 20, y: 130 }}>
              ...
              validationResult.includes("Accept")
                ...
                : validationResult.includes("Reject")
                  ...
                  : validationResult.includes("Valid")
                    ? isDark ? 'bg-green-900 bg-opacity-30 text-green-100' : 'bg-green-50 text-green-800 border border-green-200'
                    : isDark ? 'bg-yellow-900 bg-opacity-30 text-yellow-100' : 'bg-yellow-50 text-yellow-800 border border-yellow-200'
